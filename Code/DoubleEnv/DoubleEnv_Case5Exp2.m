...
if isempty(p)
    ...
    p.addParameter('Display','off',@(x) validatestring(x,{'on','off'},'DoubleEnv_Case5Exp2','Display'));
    p.addParameter('Jacobian','on',@(x) validatestring(x,{'on','off'},'DoubleEnv_Case5Exp2','Jacobian'));
end
