function LaplaceConstrEnvGUIVid( imwriter, env, AenvSingle, NumSynapse )
%LAPLACECONSTRENVGUIVID(env, AenvSingle, NumSynapse) GUI for
%recording constrained Laplacian envelope 
...
snr_ph=uipanel(figure1,'Units','normalized',...
    'Position',[0 0 0.7 1]);%left bottom width height
set(snr_ph,'Title','SNR curves','FontSize',AxFontSize);
%    'BackgroundColor','w',...

%current model
model_ph=uipanel(figure1,'Units','normalized',...
    'Position',[0.7 0 0.3 1]);%left bottom width height
