...
switch Interpreter
    ...
    case 'tex'
        xlabel('Mean recall time, \tau','Interpreter','tex','FontSize',16);
        ylabel('\textsf{Recognition performance,} $\overline{\mathsf{SNR}}\mathsf{(\tau)}$','Interpreter','latex','FontSize',16);
end
% title('Heuristic envelope','Interpreter',Interpreter,'FontSize',20);
title('Memory curve envelope','Interpreter',Interpreter,'FontSize',20);
% legend({'Numeric envelope',...
%     'Heuristic envelope',...
%     },...
%     'Location','northeast','Interpreter',Interpreter,'FontSize',16);
legend({'Numeric envelope',...
    'Analytic envelope',...
    },...
    'Location','northeast','Interpreter',Interpreter,'FontSize',16);
...
switch Interpreter
    case 'latex'
        annotation('textbox',...
            ...
            'String','$r\tau=0.73$',...
            'Interpreter',Interpreter,'FontSize',16,...
        ...
        annotation('textbox',...
            dsxy2figxy(gca,[xl(1) AenvHeuristic(1) taubnd(2) 2*AenvHeuristic(1)]),...
        ...
        annotation('textbox',...
            ...
            'Interpreter',Interpreter,'FontSize',22,...
    ...
    case 'tex'
        ...
        annotation('textbox',...
            dsxy2figxy(gca,[xl(1) AenvHeuristic(1) taubnd(2) 2*AenvHeuristic(1)]),...
            'String','$\frac{\sqrt{\mathsf{N}}}{1+\mathsf{r\tau}}$',...
            'Interpreter','latex','FontSize',22,...
            'LineStyle','none','VerticalAlignment','baseline','HorizontalAlignment','left');

        annotation('textbox',...
            dsxy2figxy(gca,[taubnd(2) Abnd(2)/2 taubnd(1) Abnd(2)]),...
            'String','$\frac{\mathsf{1.1}\sqrt{\mathsf{N}}}{\sqrt{\mathsf{r\tau}}}$',...
            'Interpreter','latex','FontSize',22,...
            'LineStyle','none','VerticalAlignment','bottom','HorizontalAlignment','right');
