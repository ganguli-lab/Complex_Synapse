function [ newWp,newWm,newQ,neww,ix ] = SortByWtEtaSHom( Wp,Wm,Q,w,fp,s )
%[newW,neww,ix]=SORTBYETAHom(M,w,fp) Put states in order of decreasing eta^+
...
Zinvs=s*eye(length(Wp)) + ones(length(Wp)) - fp*newWp - (1-fp)*newWm - newQ;
deta=-Zinvs\w;
