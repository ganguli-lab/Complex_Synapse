...
\begin{table}
 \begin{center}
  \begin{tabularn}{|l|c|c|c|c|c|c|}
    ...
    \cline{1-7}
    Serial        & 10 & $q=0.3$  & $q=0.4$  & 0.1  & 5 & 20  &\label{tr:multistate_weak} \\
    Serial        & 10 & $q=0.3$  & $q=0.4$  & 0.3  & 5 & 20  &\label{tr:multistate_med} \\
    Serial        & 10 & $q=0.3$  & $q=0.4$  & 0.45 & 5 & 30  &\label{tr:multistate_strong} \\
    Two-state     & 2  & $q=0.1$  & $q=0.2$  & 0.1  & 5 & 5   &\label{tr:binary} \\
    Multistate    & 10 & $q=0.3$  & $q=0.4$  & 0.3  & 5 & 5   &\label{tr:multistate_lin} \\
    Pooled        & 10 & $q\in[0.3,0.4]$  & $q\in[0.6,0.8]$
                                          & 0.1 & 5 & 20 &\label{tr:pooled_plenty}\\
    Pooled        & 10 & $q\in[0.05,0.4]$  & $q\in[0.1,0.8]$
                                          & 0.1 & 5 & 20 &\label{tr:pooled_scarce}\\
    Cascade       & 10 & $x=0.25$ & $x=0.33$ & 0.3  & 5 & 20  &\label{tr:cascade_short} \\
    Cascade       & 10 & $x=0.25$ & $x=0.33$ & 0.3  & 5 & 100 &\label{tr:cascade_long} \\
    Non-uniform MS       & 10 & $x=0.25$ & $x=0.33$ & -0.3  & 50 & 150 &\label{tr:nonuni} \\
    \cline{1-7}
%   \hline
%    % after \\: \hline or \cline{col1-col2} \cline{col3-col4} ...
%    & Model & \# states & pot,WT dep & \KO\ dep & $\Delta f$ & $r\ttrain$ & $r\tpre$ \\
