...
\begin{preview}
 \begin{center}
  ...
  \begin{tabular}{l@{\hspace{0.05\linewidth}}l}
    ...
    \item\aligntop{\includegraphics[height=2.3cm]{pooled_deponly.svg}}\label{fig:pooled_model}&
...
\begin{myenumA}
  ...
  \begin{tabular}{|l|c|c|c|c|c|c|c|c|}
    ...
    Cascade  & 14 & $0.386$  & $0.398$  & $0.466$  & 0.478 & 0.63 & 0.002  & 200  \\%&\label{tr:cascade_fit} \\
...
This seems to be because the enhanced depression results in a greater fraction of synapses starting in states of weaker synaptic weight %(see \autoref{fig:nonuni}\ref{fig:nonuni_eq}\ref{fig:nonuni_eq_KO})
...
\begin{preview}
  ...
  \item\aligntop{\includegraphics[width=0.29\linewidth]{binary_longterm.eps}}\label{fig:binary_longterm}
  \item\aligntop{\includegraphics[width=0.29\linewidth]{multistate_longterm.eps}}\label{fig:multistate_longterm} \\
  \item\aligntop{\includegraphics[width=0.29\linewidth]{pooled_longterm.eps}}\label{fig:pooled_longterm}
