...
This reduces the typical number of candidate depression events required to induce a change in synaptic weight, modelling the observed lower threshold for LTD \cite{McConnell2009MHCcerebellum}.
...
In some cases a very small learning impairment was seen, but these occurred at extreme parameter values where floating point precision could become an issue.
...
\begin{figure}
  \centering
  \begin{myenuma}
    \item\aligntop{\includegraphics[width=0.29\linewidth]{pooled_deponly_scan.eps}}\label{fig:pooled_bal}
  ...
  The exceptions are very small, and tend to occur at extreme parameter values where rounding errors may occur.
  }\label{fig:bal}
\end{figure}
