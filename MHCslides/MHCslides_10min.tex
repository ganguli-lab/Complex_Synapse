...
%
\subtitle{\small{based on work in preparation with: T.D. Barbara Nguyen-Vu, Grace Q. Zhao, Aparna Suvrathan, Han-Mi Lee, Surya Ganguli, Carla J. Shatz, Jennifer L. Raymond
}}
%
...
%
 Learning rate $\sim$ intrinsic plasticity rate $\times$ \# synapses available for LTD.
 \begin{center}
% \begin{tabular}{ccc}
%   Error model & \hspace{0.1\linewidth} & Saturation model \\[1cm]
%   \alignmid{\includegraphics[width=0.3\linewidth]{err_model.svg}} &&
   \aligntop{\includegraphics[width=0.25\linewidth]{sat_model.svg}}
   \hspace{0.1\linewidth}
   \parbox[t]{0.6\linewidth}{%
   \begin{itemize}
   \visible<2>{
     \item Mimic depletion with ChR2 stim of CF
     \item Biochemical marker of LTD
   \end{itemize}
   
   \vp
   \aligntop{\includegraphics[width=0.99\linewidth]{desat.svg}}}
   }
   
   \vp\alert{Question 1:} Can depletion effect overcome enhanced intrinsic plasticity? 
...
% \note[item]{Older explanation: error model}
 ...
 \note[item]<2>{Prediction: replenish with rev-training \lto\ rescue}
%
\end{frame}
...
%
   %\vp 
   \includegraphics[width=0.6\linewidth]{gain_dec.svg}
   
   \vp
   \visible<2->{
   \alignmid{\includegraphics[width=0.2\linewidth]{data_shifted_WT.svg}}
   \hspace{0.2\linewidth}
   \alignmid{\includegraphics[width=0.2\linewidth]{data_shifted_KO.svg}}
   }
 \end{center}
 
 \visible<2->{\alert{Question 2:} How can \emph{too much} replenishment impair learning?}
 %
 ...
 \note[item]{Focus on gain inc part}
%
\end{frame}
...
\begin{frame}{Models of synaptic dynamics}
%
%  There are $N$ identical synapses with $M$ internal functional states.
  ...
  \parbox[t]{0.25\linewidth}{VOR gain increase}
...
%
 \begin{center}
 \begin{tabular}{c@{\hspace{0.1\linewidth}}c}
   \aligntop{\includegraphics[height=0.15\linewidth]{binary.svg}} &
   \aligntop{\includegraphics[height=0.19\linewidth]{VORinc.svg}}\\[2cm]
   \aligntop{\includegraphics[height=0.35\linewidth]{binary_learnS.svg}} &
   \aligntop{\includegraphics[height=0.35\linewidth]{data_shifted.svg}}
 \end{tabular}
 \end{center}
...
\begin{frame}{Complex synapses can explain the data}
%
 \begin{center}
 \begin{tabular}{c@{\hspace{0.1\linewidth}}c}
...
%
 ...
 \begin{center}
 \begin{tabular}{c@{\hspace{0.1\linewidth}}c}
   {\includegraphics[height=0.3\linewidth]{binary_bar_ko_wo_s.svg}}&
   {\includegraphics[height=0.3\linewidth]{serial_bar_ko_wo_s.svg}}\\[1cm]
