...
%}}
%
\author[S.~Lahiri et al.]{Subhaneil Lahiri, Barbara Nguyen-Vu, Grace Zhao, Aparna Suvrathan, Han-Mi Lee, Surya Ganguli, Carla Shatz and Jennifer Raymond%\inst{1}
}
%
\institute[Stanford]{%
%\inst{1}
...
%    \only<15>{\aligntop{\includegraphics[width=0.5\linewidth]{Animation/serial.svg}}}%
    ...
    Training: freq.\ of pot/dep events \\ \vp
...
%
 ...
 \begin{tabular}{c@{\hspace{0.1\linewidth}}c}
   ...
   \only<2-5>{\aligntop{\includegraphics[height=0.15\linewidth]{binary.svg}}}%
   &
