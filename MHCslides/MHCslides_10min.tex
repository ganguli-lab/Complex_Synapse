...
%
 ...
 \begin{tabular}{c@{\hspace{0.1\linewidth}}c}
   ...
   \only<2>{\aligntop{\includegraphics[height=0.35\linewidth]{binary_bar_ko_wo_s.svg}}}%
   \only<3>{\aligntop{\includegraphics[height=0.35\linewidth]{binary_bar_wt_w_s.svg}}}%
   &
