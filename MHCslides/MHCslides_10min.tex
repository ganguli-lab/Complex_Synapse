...
%  \end{overlayarea}
    \movie[width=200px,height=92px,showcontrols=true,loop]{\includegraphics[width=200px,height=92px]{Vids/plast_00.png}}{plast.avi}
  \end{center}
...
%
 ...
 \begin{tabular}{c@{\hspace{0.1\linewidth}}c}
   ...
   \only<1>{\aligntop{\includegraphics[height=0.35\linewidth]{binary_learnS.svg}}}%
   \only<2>{\aligntop{\includegraphics[height=0.35\linewidth]{binary_learnS_top.svg}}}%
   \only<3>{\aligntop{\includegraphics[height=0.35\linewidth]{binary_bar_ko_wo_s.svg}}}%
   \only<4>{\aligntop{\includegraphics[height=0.35\linewidth]{binary_learnS_left.svg}}}%
   \only<5>{\aligntop{\includegraphics[height=0.35\linewidth]{binary_bar_wt_w_s.svg}}}%
   &
   \only<1>{\aligntop{\includegraphics[height=0.35\linewidth]{data_shifted_nl.svg}}}%
   \only<2-3>{\aligntop{\includegraphics[height=0.35\linewidth]{data_shifted_top_nl.svg}}}%
   \only<4-5>{\aligntop{\includegraphics[height=0.35\linewidth]{data_shifted_left_nl.svg}}}%
 \end{tabular}
 \end{center}
...
%
 ...
 \begin{tabular}{c@{\hspace{0.1\linewidth}}c}
   ...
   &
   \aligntop{\includegraphics[height=0.35\linewidth]{data_shifted_nl.svg}}
 \end{tabular}
 \end{center}
 \note[item]{Serial: still only two weights. Works.}
 \note[item]{Understand by looking at distributions before training}
