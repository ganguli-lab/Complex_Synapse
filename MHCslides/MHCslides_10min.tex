...
\title[Impaired/enhanced learning w/ enhanced plasticity]{Modeling impaired  and enhanced learning with enhanced plasticity}
%
\subtitle{\small{based on work with: T.D. Barbara Nguyen-Vu, Grace Q. Zhao, Aparna Suvrathan, Han-Mi Lee, Surya Ganguli, Carla J. Shatz, Jennifer L. Raymond
}}
%
...
\parbox[t]{0.29\linewidth}{%
 ...
 \lto\ Necessary \& sufficient conditions on complex synapses to replicate it.
...
%
   %\vp
   \only<1>{\includegraphics[width=0.7\linewidth]{gain_dec.svg}}%
%
%   \vp
   \only<2->{
   \begin{tabular}{c@{\hspace{0.2\linewidth}}c}
   WT &  \color{red!60!black}{Enh.\ Plast.}\\[0.2cm]
   \aligntop{\includegraphics[width=0.3\linewidth]{data_shifted_WT.svg}}
   &
   \aligntop{\includegraphics[width=0.3\linewidth]{data_shifted_KO.svg}}
   \end{tabular}
   }
 \end{center}

 \visible<2->{\vp\alert{Question 2:} How can \emph{too much} replenishment impair learning?}
 %
...
%  There are $N$ identical synapses with $M$ internal functional states.
  ...
  \onslide<2>{\citerr{Smith2006savings}}
  %
...
%   \aligntop{\includegraphics[height=0.19\linewidth]{VORinc.svg}}\\[2cm]
%   \aligntop{\includegraphics[height=0.35\linewidth]{serial_fit_learnS.svg}} &
%   \aligntop{\includegraphics[height=0.35\linewidth]{data_shifted.svg}}
% \end{tabular}
% \end{center}
% \note[item]{Serial: still only two weights. Works.}
