...
\parbox[t]{0.29\linewidth}{%
 \hfill\onslide<3->{\alignmid{\includegraphics[width=0.4\linewidth]{the_brain_by_lonewolf16.jpg}}}
}
 \\
...
\parbox[t]{0.29\linewidth}{%
 \hfill\onslide<3->{\alignmid{\includegraphics[width=0.4\linewidth]{pinky_by_lonewolf16.jpg}}}
}
 \\
 ...
 \onslide<4->\vp Mice with enhanced cerebellar plasticity can show both impaired and enhanced learning.
...
%
 ...
 \begin{itemize}
   \item Cerebellar learning of mice with enhanced plasticity
...
% \note[item]{Horz and vert comparisons: conceptual}
 ...
 \note[item]<4->{rev helps Enh.Plas. but hurts WT}
