...
%
 ...
 \onslide<2->But often: \lto\ impairment.\\
...
%   \alignmid{\includegraphics[width=0.3\linewidth]{err_model.svg}} &&
   {\includegraphics[width=0.25\linewidth]{sat_model.svg}}\\
% \end{tabular}
   \vp    \visible<2>{\aligntop{\includegraphics[width=0.7\linewidth]{desat.svg}}}
...
%
 \begin{center}
   ...
   \only<5>{\alignmid{\includegraphics[width=0.55\linewidth]{comparisons_left.svg}}}%
...
% \note[item]{Horz and vert comparisons: conceptual}
 \note[item]<2->{Enh.Plas. hurts w/o, but helps w/}
 \note[item]<4->{pre helps Enh.Plas. but hurts WT}
...
%
 \begin{itemize}
   \item<2-> Can the depletion effect overcome intrinsic plasticity?
...
%
 ...
 \end{center}
  %
  \note[item]{Not just synaptic weight}
