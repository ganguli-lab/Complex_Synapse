...
%
 %
 \begin{center}
   \only<1-2>{\alignmid{\includegraphics[height=0.3\linewidth]{binary_bar_ko_wo_s.svg}}}
   \only<3>{\alignmid{\includegraphics[height=0.3\linewidth]{binary_bar_wt_w_s.svg}}}
   \hspace{0.1\linewidth}
