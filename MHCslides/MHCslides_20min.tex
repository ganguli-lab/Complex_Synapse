...
%}}
%
\author[S.~Lahiri et al.]{Subhaneil Lahiri \texorpdfstring{\\}{} with: Barbara Nguyen-Vu, Grace Zhao, Aparna Suvrathan, Han-Mi Lee, Surya Ganguli, Carla Shatz and Jennifer Raymond%\inst{1}
}
%
\institute[Stanford]{%
%\inst{1}
...
%
 ...
 \vp
 \alignmid{\includegraphics[width=0.3\linewidth]{limitless_xlg.jpg}}
 \hp
 \alignmid{\includegraphics[width=0.6\linewidth]{Limitless1noblkborders.png}}
%
\end{frame}
...
{}
 ...
 \begin{center}
   ...
   %
%   \only<1>{\aligntop{\includegraphics[width=0.3\linewidth]{sat_model_1.svg}}}%
%   \only<2>{\aligntop{\includegraphics[width=0.3\linewidth]{sat_model_2.svg}}}%
   %
...
%
 %
 \begin{center}
    \only<1>{\aligntop{\includegraphics[width=0.5\linewidth]{Animation/learn_anim_wt.svg}}}%
    \only<2>{\aligntop{\includegraphics[width=0.5\linewidth]{Animation/learn_anim_1.svg}}}%
    \only<3>{\aligntop{\includegraphics[width=0.5\linewidth]{Animation/learn_anim_21.svg}}}%
    \only<4>{\aligntop{\includegraphics[width=0.5\linewidth]{Animation/learn_anim_41.svg}}}%
    \only<5>{\aligntop{\includegraphics[width=0.5\linewidth]{Animation/learn_anim_61.svg}}}%
    \only<6>{\aligntop{\includegraphics[width=0.5\linewidth]{Animation/learn_anim_81.svg}}}%
    \only<7>{\aligntop{\includegraphics[width=0.5\linewidth]{Animation/learn_anim_101.svg}}}%
    \only<8>{\aligntop{\includegraphics[width=0.5\linewidth]{Animation/learn_anim_wt.svg}}}%
...
%   enhanced learning
 ...
 \vp\alert{Key feature 2:} Synaptic stubbornness --
 metaplasticity where repeated \\ \hfill potentiation impairs subsequent depression.
...
%
 ...
 \begin{itemize}
   \item Complexity - needed to for depletion to dominate enhanced plasticity,
