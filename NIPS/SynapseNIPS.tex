...
\begin{figure}
 \begin{center}
 \begin{myenuma}
  \item\hp\aligntop{\includegraphics[width=0.25\linewidth]{max_init_pot.svg}}\label{fig:max_init_pot}\hp
  \item\aligntop{\includegraphics[width=0.25\linewidth]{max_init_dep.svg}}\label{fig:max_init_dep}\hp
  \item\aligntop{\includegraphics[width=0.1\linewidth]{binary_det.svg}}\label{fig:binary_det}
  \end{myenuma}
 \end{center}
