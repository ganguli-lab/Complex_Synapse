...
\end{equation}
%
which describes the synapses starting in the equilibrium distribution, changing state due to the plasticity event at $t=0$ and subsequent evolution according to \eqref{eq:rowsum} due to plasticity events uncorrelated with the special event at $t=0$.%
