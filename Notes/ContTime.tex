...
We can rewrite this using \eqref{eq:diffpT}, with $A=\sqrt{N}(2f^+f^-)\hat{A}$ and $\enc_{ij} \equiv \diff{\frg_{ij}}{\alpha}=\W^+_{ij}-\W^-_{ij}$
%
...
We can choose $q_1=0$, $\uv^1=\onev$ and $\vv=\eq$.
