...
We already know that $C(0)=\frac{1}{M-1}$ and $C(s) \to s$ as $s\to\infty$.

In the eigenmode decomposition, this reads
%
...
\begin{aligned}
  \CI &= B(s_0)(q+s_0) = B(s_1)(q+s_1) \qquad
...
\begin{equation}\label{eq:env}
  \snr(t) = \frac{\e^{(s_0-1/t_0)t}}{C'(s_0)},
  \qquad
  \snr(t_0) = \frac{\e^{s_0t_0-1}}{C'(s_0)},
\end{equation}
%
where $s_0$ is determined as a function of $t_0$ by \eqref{eq:envs0t0}.
