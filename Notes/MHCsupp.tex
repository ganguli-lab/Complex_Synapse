...
and the two-state model (which can be thought of as a special case of the multistate model, see \autoref{fig:models}\ref{fig:binary_model}),
...
This ensures that the qualitative questions (enhancement or impairment of learning) will not be affected.
