...
%  \begin{tabular}{|l|c|c|c|c|c|c|>{\refstepcounter{tablerow}}l}
    \cline{1-7}
...
\begin{figure}
 \begin{center}
 \begin{myenuma}
  \item\aligntop{\includegraphics[width=7cm]{pooled_plenty_learn.eps}}\label{fig:pooled_plenty_learn}
  \item\aligntop{\includegraphics[width=7cm]{pooled_plenty_learnS.eps}}\label{fig:pooled_plenty_learnS}
  \item\label{fig:pooled_plenty_eq}\begin{myenumi}
                    \item\aligntop{\includegraphics[width=7cm]{pooled_plenty_eq_WT.eps}}\label{fig:pooled_plenty_eq_WT}
                    \item\aligntop{\includegraphics[width=7cm]{pooled_plenty_eq_KO.eps}}\label{fig:pooled_plenty_eq_KO}
                  \end{myenumi}
  \item\label{fig:pooled_plenty_pr}\begin{myenumi}
                    \item\aligntop{\includegraphics[width=3cm]{pooled_plenty_pr_WT_nopre.eps}}\label{fig:pooled_plenty_pr_WT_nopre}
                    \item\aligntop{\includegraphics[width=3cm]{pooled_plenty_pr_WT_pre.eps}}\label{fig:pooled_plenty_pr_WT_pre}
                    \item\aligntop{\includegraphics[width=3cm]{pooled_plenty_pr_KO_nopre.eps}}\label{fig:pooled_plenty_pr_KO_nopre}
                    \item\aligntop{\includegraphics[width=3cm]{pooled_plenty_pr_KO_pre.eps}}\label{fig:pooled_plenty_pr_KO_pre}
                  \end{myenumi}
 \end{myenuma}
 \end{center}
...
\begin{figure}
 \begin{center}
 \begin{myenuma}
  \item\aligntop{\includegraphics[width=7cm]{pooled_scarce_learn.eps}}\label{fig:pooled_scarce_learn}
  \item\aligntop{\includegraphics[width=7cm]{pooled_scarce_learnS.eps}}\label{fig:pooled_scarce_learnS}
  \item\label{fig:pooled_scarce_eq}\begin{myenumi}
                    \item\aligntop{\includegraphics[width=7cm]{pooled_scarce_eq_WT.eps}}\label{fig:pooled_scarce_eq_WT}
                    \item\aligntop{\includegraphics[width=7cm]{pooled_scarce_eq_KO.eps}}\label{fig:pooled_scarce_eq_KO}
                  \end{myenumi}
  \item\label{fig:pooled_scarce_pr}\begin{myenumi}
                    \item\aligntop{\includegraphics[width=3cm]{pooled_scarce_pr_WT_nopre.eps}}\label{fig:pooled_scarce_pr_WT_nopre}
                    \item\aligntop{\includegraphics[width=3cm]{pooled_scarce_pr_WT_pre.eps}}\label{fig:pooled_scarce_pr_WT_pre}
                    \item\aligntop{\includegraphics[width=3cm]{pooled_scarce_pr_KO_nopre.eps}}\label{fig:pooled_scarce_pr_KO_nopre}
                    \item\aligntop{\includegraphics[width=3cm]{pooled_scarce_pr_KO_pre.eps}}\label{fig:pooled_scarce_pr_KO_pre}
                  \end{myenumi}
 \end{myenuma}
 \end{center}
