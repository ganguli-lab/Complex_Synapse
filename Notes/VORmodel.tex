...
\resultsfig{Simulation results for the multistate model with weak training}{($\Delta f=-0.1$)}{multistate_weak}

\resultsfig{Simulation results for the multistate model with moderate training}{($\Delta f=-0.17$)}{multistate_med}

\resultsfig{Simulation results for the multistate model with strong training}{($\Delta f=-0.4$)}{multistate_strong}
