...
This is related to the fact that \autoref{fig:envvid} and the video shows that the optimal models do not6 shorten by one state at a time, but several outgoing transition probabilities are reduced at once.
