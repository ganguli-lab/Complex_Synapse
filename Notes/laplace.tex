...
\end{equation}
%
Therefore, provided that state \(i\) has nonzero equilibrium probability, degeneracy in \(\etw\) implies degeneracy in \(\thb\).
...
\Cref{eq:KKTz} will provide another expression for \(\kktm^\nu_{mm}\).
