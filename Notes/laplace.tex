...
\begin{aligned}
  ...
  &= \frac{1}{rf\pot} \brk{\pdiff{\CL}{\MMdm\pot_{mj}} - \pdiff{\CL}{\MMdm\pot_{mi}}} -
  \frac{1}{rf\dep} \brk{\pdiff{\CL}{\MMdm\dep_{mj}} - \pdiff{\CL}{\MMdm\dep_{mi}}} \\ 
...
\begin{equation}\label{eq:pertK}
  \frac{1}{rf\pot} \pdiff{\CL}{\MMdm\pot_{mn}} -
  \frac{1}{rf\dep} \pdiff{\CL}{\MMdm\dep_{mn}} =
...
\begin{aligned}
  ...
  ,\\
  c_{k+1} - c_k &= r\prn{\eqm_{k} \frgm_{k,k+1} + \eqm_{k+1} \frgm_{k+1,k}}
