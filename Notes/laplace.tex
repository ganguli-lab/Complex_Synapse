...
\begin{equation}\label{eq:shiftqderiv}
  ...
  \frac{1}{f\pot} \pdiff{\CL}{\MMdm\pot_{mn}} - \frac{1}{f\pot} \pdiff{\CL}{\MMdm\dep_{mn}}
   = \mu\pot_{mn} - \mu\dep_{mn} + 2\eqm_m (\etwm_m - \etwm_n)
   = 0.
\end{equation}
%
...
\end{equation}
%
bNumerical maximisation of the quantity above produces the same result as in \cref{sec:initial}:
...
\begin{table}[tb]
  ...
  \begin{tabular}{BACCCCCC}
    \toprule
      ...
      \\
    \midrule
      0 &\leq r \tau &\leq 2 & M &\geq 3 & 1 & 2/r 
        & \frac{4 - 2r \tau}{[2 + r \tau]^2} & \frac{2\sqrt{2}r\tau}{[2 + r \tau]^2} & 0 
        % & \frac{2 \sqrt{N}}{2 + r \tau} 
      \\
      2 &< r \tau &< \frac{(M-1)^2}{2} & M &> 3 & \sqrt{\frac{2}{r\tau}} & \tau 
        & 0 & \frac{1}{2\sqrt{r \tau}} & 0 
        % & \sqrt{\frac{N}{2 r \tau}} 
      \\ \addlinespace[0.2ex]
      \frac{(M-1)^2}{2} &\leq r \tau & & M &\geq 3 & \frac{2}{M-1} & \frac{(M-1)^2}{2r} 
