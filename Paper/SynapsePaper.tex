...
%\makeatletter
%\DeclareRobustCommand{\ilabel}[1]{%
%   \edef\@currentlabel{\themyenumai}%
%   \label{#1}}
%\makeatother
\graphicspath{{"Figs/"}}
%\usepackage{pnastwoF}
...
\abbreviations{SNR, signal-to-noise ratio; LTP, long term potentiation;
...
\begin{figure}[tbp]
 \begin{center}
 \begin{myenuma}
  \item\hp\aligntop{\includegraphics[width=0.24\linewidth]{max_init_pot.svg}}\label{fig:max_init_pot}\hp
  \item\aligntop{\includegraphics[width=0.24\linewidth]{max_init_dep.svg}}\label{fig:max_init_dep}\hp
  \item\hp\aligntop{\includegraphics[width=0.1\linewidth]{binary_det.svg}}\label{fig:binary_det}
  \end{myenuma}
 \end{center}
...
\begin{figure}
 ...
 \begin{myenuma}
  \item\aligntop{\includegraphics[width=0.85\linewidth]{env.svg}}\label{fig:envplot}
 \end{myenuma}
  }\hp
...
We will see in \sref{sec:multistate} that the optimal chain is absorbing, so it lies on the boundary of the (open) set of ergodic chains, but it still puts an upper bound on the area for any chain in the interior.
