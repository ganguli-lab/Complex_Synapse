...
\titlegraphic{\includegraphics[height=10cm]{bio-x.eps}%
    \hspace{1cm}\includegraphics[height=10cm]{swartz.eps}}
...
%
 \begin{minipage}[t]{0.49\linewidth}
   ...
   \vp
   \begin{center}
    \aligntop{\includegraphics[width=0.6\linewidth]{2000102CobaFig4.pdf}}
   \end{center}
...
%
 ...
 %
 \begin{center}
   \includegraphics[height=4cm]{max_init_pot.svg}
   \hspace{2cm}
   \includegraphics[height=4cm]{max_init_dep.svg}
 \end{center}
...
%
 ...
 \vp Are there any other important constraints?
%
\end{block}
...
\parbox[c]{0.45\linewidth}{
 \begin{center}
   \aligntop{\includegraphics[width=0.89\linewidth]{RunningAveEnv.svg}}
 \end{center}
}
\hspace{0.5cm}
\parbox[c]{0.45\linewidth}{
