...
% ----------------------------------------------------------------
% set paoster height and length
\newcommand{\myposterwidth}{152.4cm}
\newcommand{\myposterheight}{106.68cm}
...
\titlegraphicl{\includegraphics[height=10cm]{SU_Seal_Card_pos.eps}%
    \hspace{1cm}\includegraphics[height=10cm]{bio-x.eps}}
\titlegraphic{\includegraphics[height=8cm]{Genentech.eps}%
    \hspace{1cm}\includegraphics[height=8cm]{swartz.eps}}
...
%
 \begin{minipage}[t]{0.51\linewidth}
   ...
   \vp
   \begin{center}
    \aligntop{\includegraphics[width=0.58\linewidth]{2000102CobaFig4.pdf}}
   \end{center}
...
% These have different memory storage properties
 \parbox[t]{0.47\linewidth}{
 \begin{center}
 \aligntop{\includegraphics[width=0.65\linewidth]{cascms.eps}}
 \end{center}
}
...
% \begin{center}
\hspace{2cm}
   \aligntop{\includegraphics[height=6cm]{max_init_pot.svg}}
   \hspace{2cm}
   \aligntop{\includegraphics[height=6cm]{max_init_dep.svg}}
% \end{center}
