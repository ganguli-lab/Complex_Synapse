...
%
 \begin{minipage}[t]{0.47\linewidth}
   ...
   \vp
   \begin{center}
     \aligntop{\includegraphics[width=0.76\linewidth]{synapse.svg}}
   \end{center}
 \end{minipage}
 %
 %\hspace{1cm}
 ...
 \begin{minipage}[t]{0.49\linewidth}
   \begin{center}
    \aligntop{\includegraphics[width=0.96\linewidth]{2000102CobaFig4.pdf}}
   \end{center}
    \citerr{Coba2009phosphorylation}

   \begin{center}
   \aligntop{\includegraphics[width=0.32\linewidth]{pot.svg}}
   \hspace{2cm}
   \aligntop{\includegraphics[width=0.32\linewidth]{dep.svg}}
   \end{center}
 \end{minipage}
%
\end{block}
...
%
 ...
 \begin{center}
% \parbox[t]{30cm}{
  \aligntop{\includegraphics[width=0.35\linewidth]{cascade.svg}}
  \hspace{2cm}
  \aligntop{\includegraphics[width=0.35\linewidth]{serial.svg}}
% }
 \end{center}
