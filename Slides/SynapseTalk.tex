...
%
 ...
 \begin{equation*}
   \begin{aligned}
     ...
     \text{Noise} &= \sqrt{\var\prn{\wv_\text{ideal} \cdot \wv(\infty)}} \sim \sqrt{N}.
   \end{aligned}
 \end{equation*}
 %
 \note[item]{ideal: pot$\to$strong...}
 \note[item]{use $\wv_\text{ideal} \cdot \wv(\infty)$ as null model}
...
% \begin{center}
 \parbox[c]{0.58\linewidth}{
   \aligntop{\includegraphics[width=0.95\linewidth]{env_num.eps}}
