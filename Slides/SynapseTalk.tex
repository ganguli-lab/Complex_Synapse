...
%
 ...
 \only<5>{\aligntop{\includegraphics[width=0.35\linewidth]{network5.svg}}}%
 \only<6>{\aligntop{\includegraphics[width=0.35\linewidth]{network6.svg}}}%
 \only<7>{\aligntop{\includegraphics[width=0.35\linewidth]{network7.svg}}}%
 \only<8>{\aligntop{\includegraphics[width=0.35\linewidth]{network8.svg}}}%
 \end{center}
...
%
 ...
 %
 \begin{center}
   \only<1>{\aligntop{\includegraphics[width=0.9\linewidth]{LEnvConstrEarly09.svg}}}%
   \only<2>{\aligntop{\includegraphics[width=0.9\linewidth]{LEnvConstrEarly44.svg}}}%
 \end{center}
%
%
\end{frame}
...
%
 ...
 %
 \begin{center}
   \only<1>{\aligntop{\includegraphics[width=0.9\linewidth]{LEnvConstrLate41.svg}}}%
   \only<2>{\aligntop{\includegraphics[width=0.9\linewidth]{LEnvConstrLate06.svg}}}%
 \end{center}
%
%
\end{frame}
