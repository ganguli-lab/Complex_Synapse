...
%
 ...
 \only<4>{\aligntop{\includegraphics[width=0.275\linewidth]{perceptron4.svg}}}%
 \only<5>{\aligntop{\includegraphics[width=0.275\linewidth]{perceptron5.svg}}}%
 \only<6>{\aligntop{\includegraphics[width=0.275\linewidth]{perceptron6.svg}}}%
 \only<7>{\aligntop{\includegraphics[width=0.275\linewidth]{perceptron7.svg}}}%
 \only<8-9>{\aligntop{\includegraphics[width=0.275\linewidth]{perceptron8.svg}}}%
 \end{center}
