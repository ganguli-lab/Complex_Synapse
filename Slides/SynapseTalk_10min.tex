...
%
 ...
 %
 \begin{center}
   \visible<2>{\includegraphics[width=0.55\linewidth]{MemoryCurve.svg}}
 \end{center}
 %
%
\end{frame}
...
%
 \begin{itemize}
   ...
   \vp\item Which models achieve them?
   \vp\item What are the theoretical principles behind them?
 \end{itemize}
%
\end{frame}
...
%
 ...
 \vp\visible<2>{Subject a synapse to a sequence of candidate plasticity events.
