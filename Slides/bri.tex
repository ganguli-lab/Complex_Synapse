...
\begin{overlayarea}{0.95\linewidth}{0.2\textheight}
 \begin{center}
   ...
   \only<7,8>{\includegraphics[width=0.5\linewidth]{MemorySequence_a7.svg}}%
 \end{center}
\end{overlayarea}
 %
...
% Synapses store a sequence of memories.\\
 ...
 Performance described by SNR of $\syn(t)\cdot\syn_\text{test}$.
 %
 \begin{center}
...
\begin{tabular}{lll}
  ...
  Jascha Sohl-Dickstein  & Ben Poole            & {Barbara Nguyen-Vu} \\
  Friedemann Zenke       & Kiah Hardcastle      & {Grace Zhao}        \\
