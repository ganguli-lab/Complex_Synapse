...
\section[Learning with enhanced plasticity]{Learning with enhanced plasticity}
\frame{\sectionpage 
...
\newblock 
\href{http://dx.doi.org/10.7554/eLife.20147}{\emph{eLife}, 6:\penalty0 e20147}, (February, 2017).
\end{center}
...
\frame{\sectionpage
\begin{center}
\newblock ``A memory frontier for complex synapses''.
\newblock Subhaneil Lahiri and Surya Ganguli.
\newblock \href{https://papers.nips.cc/paper/4872-a-memory-frontier-for-complex-synapses}
{\emph{Adv. Neural Inf. Process. Syst. 26}, pp.\ 1034--1042.} NeurIPS, 2013.
\end{center}
}
...
%   \only<5>{\aligntop{\includegraphics[width=0.97\linewidth]{Animation/FitVid939.svg}}}%
   \includegraphics[height=0.8\textheight]{Animation/FitVidFinal.svg}
 \end{center}
 %
