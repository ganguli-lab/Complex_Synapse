...
\begin{frame}{Random projections and neural recordings}
%
 \fbox{Relevant neurons} $\to$ \fbox{Recorded neurons} $\to$ \fbox{Electrodes}.


\begin{overlayarea}{0.95\linewidth}{0.5\linewidth}
 \only<1>{
 \vp Previous work argued: 1st projection $\implies$ {undistorted} popn.\ dynamics.
 \\ \citerr{Gao2015dimension}
 }

 \only<2->{
 \vp 2nd projection (reversed by spike sorting):
 \citerr{Trautmann2017sortfree}
 }
 
 \only<2>{
 \vp\aligntop{\includegraphics[width=0.45\linewidth]{Others/concept.pdf}}
 \hp\aligntop{\includegraphics[height=0.3\linewidth]{Others/psths_1.pdf}}
 \aligntop{\includegraphics[height=0.3\linewidth]{Others/psths_2.pdf}}
 }
 
 \only<3>{
 \vp\aligntop{\includegraphics[width=0.45\linewidth]{Others/scaling.pdf}}
 \hp\aligntop{\includegraphics[width=0.45\linewidth]{Others/simulation.pdf}}
 }
\end{overlayarea}
...
\begin{frame}{Random projections of random manifolds}
%
 \alignmid{\includegraphics[width=0.4\linewidth]{Others/embed.svg}}
 \hp\hp
% \only<1>{\alignmid{\includegraphics[width=0.45\linewidth]{Others/M_V_all_sim.pdf}}}%
% \only<2>{\alignmid{\includegraphics[width=0.45\linewidth]{Others/M_V_all_us.pdf}}}%
% \only<3>{
 \alignmid{\includegraphics[width=0.45\linewidth]{Others/M_V_all.pdf}}
% }%
%
\end{frame}
...
\begin{frame}{Energy efficiency of cellular communication}
%
\begin{center}
 Supercomputer: 1\,MW,
 \qquad
...
\begin{overlayarea}{0.95\linewidth}{0.5\linewidth}
 ...
 \vp
 \aligntop{\includegraphics[width=0.55\linewidth]{Others/channel.svg}}
 \parbox[t]{0.4\linewidth}{%
 \centering
 $\text{Precision}^2\ \text{Speed}^2 \leq \frac{\text{Power}}{\tau k_{B} T}$.
 
 \vp%\aligntop{\includegraphics[width=0.45\linewidth]{Others/recpowplotg.svg}}
 \aligntop{\includegraphics[width=0.85\linewidth]{Others/recpowplotk.svg}}
 }
 
 \citerr{lahiri2016power}
 }
 ...
 \vp
 \aligntop{\includegraphics[width=0.45\linewidth]{Others/CellCartoon_2.pdf}}
 \hp
 \parbox[t]{0.45\linewidth}{%
 \centering
 $\text{Precision}^2\ \leq \frac{\text{Energy}}{8k_{B}T} + \frac{\text{\#(bindings)}}{2}$.

 \vp%\aligntop{\includegraphics[width=0.45\linewidth]{Others/recpowplotg.svg}}
 \aligntop{\includegraphics[width=0.95\linewidth]{Others/RingNetworkPlot.pdf}}
 }
 }
\end{overlayarea}
...
%
 %
 \begin{center}
   \only<1>{\includegraphics[width=0.5\linewidth]{MemorySequence.svg}}%
...
%
 ...
 \bibliography{maths,neuro,markov,infothermo}
 }
%
\end{frame}
