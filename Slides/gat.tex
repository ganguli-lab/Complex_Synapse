...
%   \only<5,6>{\aligntop{\includegraphics[height=0.35\linewidth]{serial_bar_wt_w_s.svg}}}%
   \only<4-5>{\aligntop{\includegraphics[height=0.35\linewidth]{serial_bar_wt_wo_s.svg}}}%
   \only<6>{\aligntop{\includegraphics[height=0.35\linewidth]{serial_fit_learnS_bottom.svg}}}%
...
%        \vp $\implies$  impaired learning}}%
   \only<4>{\aligntop{\includegraphics[height=0.35\linewidth]{serial_bar_ko_wo_s.svg}}}%
   \only<5>{\parbox[t]{0.35\linewidth}{\centering \vp %
        start in: labile states \\ $\Downarrow$  \\
        enhanced plasticity \\ $\implies$  impaired learning}}%
   \only<6>{\aligntop{\includegraphics[height=0.35\linewidth]{data_shifted_bottom_nl.svg}}}%
