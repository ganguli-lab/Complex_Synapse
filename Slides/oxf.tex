...
%
  ...
  \begin{equation*}
  \begin{aligned}
     f\potdep &= \text{fraction of events that are pot/dep,} \\
    \text{pot. event: } M\pot_{ij} &= \text{transition prob. } i \to j, \\
    \text{dep. event: } M\dep_{ij} &= \text{transition prob. } i \to j. \\
  \end{aligned}
  \end{equation*}
%
 Constraints:  
 %
 \begin{equation*}
   \M\potdep_{ij}, f\potdep \in [0,1], \qquad 
   \sum_j \M\potdep_{ij} = f\pot + f\dep = 1.
 \end{equation*}
 %
...
%
 ...
 \begin{aligned}
    ...
    \eq \frg =0, \\
   \snrb(\tau) 
        &= \sqrt{N}(2f\pot f\dep)\, \eq \prn{\M\pot-\M\dep} \brk{\I - r\tau\frg}\inv \w. \\
...
\section{Proven limits of memory}
...
%
 ...
 %
 \begin{equation*}
   \snr(0) = \sum_a \initial_a \leq \sqrt{N}.
 \end{equation*}
 %
 %
 \begin{center}
...
\section{Implications of memory limits}
