...
%
 {\parbox[c]{0.45\linewidth}{
  ...
  \only<1>{
   \begin{center}
     \aligntop{\includegraphics[height=0.75\linewidth]{Artificial_neural_network.svg}}
   \end{center}
  %
  }
  %
 ...
 {\parbox[c]{0.45\linewidth}{
  ...
  \only<1>{
   \begin{center}
     \aligntop{\includegraphics[height=0.95\linewidth]{Cajal_actx_inter.jpg}}
   \end{center}
  %
   \rref{Cajal (1899)}
  }%
  \only<2>{
   \begin{center}
     \aligntop{\includegraphics[width=0.95\linewidth]{plasticity-network.jpg}}
   \end{center}
  %
...
%{\emph{Adv.\ Neural Inf.\ Process.\ Syst.\ 26, pp.~1034--1042., (2013)}}.
%\\%\newblock
%NeurIPS 2013 Outstanding Paper Award.
%%\end{center}
%}
...
%
 %
\begin{overlayarea}{0.95\linewidth}{0.2\textheight}
 \begin{center}
   \only<1>{\includegraphics[width=0.5\linewidth]{MemorySequence_a1.svg}}%
   \only<2>{\includegraphics[width=0.5\linewidth]{MemorySequence_a2.svg}}%
   \only<3>{\includegraphics[width=0.5\linewidth]{MemorySequence_a3.svg}}%
   \only<4>{\includegraphics[width=0.5\linewidth]{MemorySequence_a4.svg}}%
   \only<5>{\includegraphics[width=0.5\linewidth]{MemorySequence_a5.svg}}%
   \only<6>{\includegraphics[width=0.5\linewidth]{MemorySequence_a6.svg}}%
   \only<7>{\includegraphics[width=0.5\linewidth]{MemorySequence_a7.svg}}%
 \end{center}
\end{overlayarea}
 %
\begin{overlayarea}{0.95\linewidth}{0.6\textheight}
\only<1-7>{
 \begin{center}
   \only<1>{\includegraphics[width=0.5\linewidth]{MemorySequence_b1.svg}}%
   \only<2>{\includegraphics[width=0.5\linewidth]{MemorySequence_b2.svg}}%
   \only<3>{\includegraphics[width=0.5\linewidth]{MemorySequence_b3.svg}}%
   \only<4>{\includegraphics[width=0.5\linewidth]{MemorySequence_b4.svg}}%
   \only<5>{\includegraphics[width=0.5\linewidth]{MemorySequence_b5.svg}}%
   \only<6>{\includegraphics[width=0.5\linewidth]{MemorySequence_b6.svg}}%
   \only<7>{\includegraphics[width=0.5\linewidth]{MemorySequence_b7.svg}}%
 \end{center}
 \begin{center}
   \only<1>{\includegraphics[width=0.5\linewidth]{MemorySequence_c1.svg}}%
   \only<2>{\includegraphics[width=0.5\linewidth]{MemorySequence_c2.svg}}%
   \only<3>{\includegraphics[width=0.5\linewidth]{MemorySequence_c3.svg}}%
   \only<4>{\includegraphics[width=0.5\linewidth]{MemorySequence_c4.svg}}%
   \only<5>{\includegraphics[width=0.5\linewidth]{MemorySequence_c5.svg}}%
   \only<6>{\includegraphics[width=0.5\linewidth]{MemorySequence_c6.svg}}%
   \only<7>{\includegraphics[width=0.5\linewidth]{MemorySequence_c7.svg}}%
 \end{center}
}
\only<7>{%
 Recognition memory: has this pattern been seen before?

 \vp Hypothesis test statistic: $\syn(t)\cdot\syn_\text{test}$.
 \citerr{Sommer1998retrieval}
 %
}
\end{overlayarea}
 %
 \note{What is SNR, what is time.}
%
\end{frame}
...
%
 ...
 \begin{center}
  ...
  \hspace{2cm}
  \aligntop{\includegraphics[width=4cm]{serial.svg}}
 \end{center}
...
%
  ...
  \begin{aligned}
    ...
    \text{pot. event: } \alert{\M\pot_{ij}} &= \text{transition prob. } i \to j, \\
%    \quad  &{\scriptstyle \W\pot =  f\pot \prn{\M\pot - I},} \\
    \text{dep. event: } \alert{\M\dep_{ij}} &= \text{transition prob. } i \to j. \\
%    \quad &{\scriptstyle \W\dep =  f\dep \prn{\M\dep - I}.} \\
  \end{aligned}
  \end{equation*}
%
...
\parbox[t]{0.6\linewidth}{
 ...
 %
 \begin{center}
   \includegraphics[height=0.167\linewidth]{binary_det.svg}
 \end{center}
 %
 }
...
%%
%%\vpp
% {{TDB~Nguyen-Vu, GQ~Zhao,} S~Lahiri, RR~Kimpo, H~Lee, S~Ganguli, CJ~ Shatz, JL~Raymond}.
%%\vpp
%\\%\newblock
%\href{http://dx.doi.org/10.7554/eLife.20147}{\emph{eLife, 6:\penalty0 e20147, (Feb., 2017)}}.
%\\%\newblock
%Highest rated abstract at Cosyne 2014.
%%\end{center}
%
...
%% -----Section-------------------------------------------------------------
%
%\subsection{Synaptic models of cerebellar learning}
%
%%%-------------Slide--------------------------------------------------------
%%
%%\begin{frame}{Synapses are complex}
...
%%-------------Slide--------------------------------------------------------
%
%\begin{frame}{Simple synapses cannot explain the behaviour}
%%
% \begin{center}
...
%   \only<4>{\parbox[t]{0.35\linewidth}{\centering \vp %
%     depletion effect\\ $<$ \\ enhanced plasticity \\
...
%%-------------Slide--------------------------------------------------------
%
%\begin{frame}{Complex metaplastic synapses can explain the behaviour}
%%
% \begin{center}
% \begin{tabular}{c@{\hspace{0.1\linewidth}}c}
...
%   \only<4>{\aligntop{\includegraphics[height=0.35\linewidth]{serial_fit_learnS_bottom.svg}}}%
%   \only<5,6>{\aligntop{\includegraphics[height=0.35\linewidth]{serial_bar_wt_wo_s.svg}}}%
%   \only<7,8>{\aligntop{\includegraphics[height=0.35\linewidth]{serial_bar_wt_w_s.svg}}}%
%   &
...
%%        \vp $\implies$  impaired learning}}%
%   \only<4>{\aligntop{\includegraphics[height=0.35\linewidth]{data_shifted_bottom_nl.svg}}}%
%   \only<5>{\aligntop{\includegraphics[height=0.35\linewidth]{serial_bar_ko_wo_s.svg}}}%
%   \only<6>{\parbox[t]{0.35\linewidth}{\centering \vp %
%        start in: labile states \\ $\Downarrow$  \\
%        enhanced plasticity \\ $\implies$  impaired learning}}%
%   \only<7>{\aligntop{\includegraphics[height=0.35\linewidth]{serial_bar_ko_w_s.svg}}}%
...
% \end{center}
% %
% \vp The serial model is successful in reproducing the data due to two features:
% \begin{itemize}
...
%%   \note[item]{\eg exponential decay, resource depletion,\ldots}
...
%   \itx\>tem Need long sequences of plasticity events.
